...
| Join case and party addresses in the case graph | Add property and party addresses to the case lookup entity graph, reducing standalone address fetches from 27,000 to 0 over 21,000 loads | 21,000 | 7.4 ms | 7.3 ms | 8.4 ms | 8.8 ms | 5.5 ms | 50.5 ms | 11.7% mean, 11.1% median | 94.1% mean, 94.4% median |
