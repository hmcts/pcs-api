...
public enum State {
    ...
    @CCD(
        ...
        access = {CaseworkerReadAccess.class, ClaimantAccess.class, DefendantAccess.class,
            DefendantSolicitorAccess.class, RasValidationAccess.class, GlobalSearchAccess.class},
        hint = "${caseTitleMarkdown}"
    )
    CASE_ISSUED,
    ...
    @CCD(
        ...
        access = {CaseworkerReadAccess.class, ClaimantAccess.class, DefendantSolicitorAccess.class,
