...
public class CannotApplyForWritInfoPage implements CcdPageConfiguration {
    ...
    public void addTo(PageBuilder pageBuilder) {
        pageBuilder
            ...
            .label("cannotApplyForWritInfo-text",
                    "<p class=\"govuk-body\">You must transfer your claim from the County Court to the High "
                    + "Court before you can apply for a writ. You need permission from a judge to do this.</p>"
                    + "<p class=\"govuk-body\">Transferring to the High Court means that a High Court "
                    + "Enforcement Officer can carry out the eviction.</p>"
                    ...
                    + "the High Court</h2>"
                    + "<p class=\"govuk-body\">You must make an application if you want to transfer your "
                    + "claim to the High Court.</p>"
                    + "<p><a href=\"/cases/case-details/${[CASE_REFERENCE]}#Service%20Request\" class=\"govuk-link\">"
