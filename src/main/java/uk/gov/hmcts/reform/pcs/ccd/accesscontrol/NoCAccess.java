...
import static uk.gov.hmcts.reform.pcs.ccd.accesscontrol.UserRole.CAA_CASE_WORKER;
...
public class NoCAccess implements HasAccessControl {
    ...
    public SetMultimap<HasRole, Permission> getGrants() {
        ...
        grants.put(CAA_CASE_WORKER, Permission.R);
        return grants;
    }
}
