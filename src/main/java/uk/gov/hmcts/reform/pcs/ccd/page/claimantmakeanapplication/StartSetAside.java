...
public class StartSetAside implements CcdPageConfiguration {
    ...
    private static final String INFO_MARKDOWN = """
        <p class="govuk-body">
        You can ask the court to set aside (cancel) an order if you have a good reason.
        </p>

        <p class="govuk-body">
        You will need to provide a good reason to ask the court to set aside the order, and you may not be successful.
        </p>
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li class="govuk-!-font-size-19">why you are asking the court to set aside the original decision</li>
        </ul>
