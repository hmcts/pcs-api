...
public class HearingFee implements NotificationGenerator {
    ...
    public List<DashboardNotification> generateActiveNotifications(PcsCase pcsCase) {
        ...
        if (pcsCase.getFeeAmount() != null && BooleanUtils.isNotTrue(pcsCase.getFeePaid())) {
