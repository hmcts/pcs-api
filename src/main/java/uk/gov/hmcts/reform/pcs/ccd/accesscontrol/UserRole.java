...
public enum UserRole implements HasRole {
    ...
    CTSC_ADMIN("ctsc", Permission.CRU, RAS, STAFF_PROFILE),
    HEARING_CENTRE_ADMIN("hearing-centre-admin", Permission.CRU, RAS, STAFF_PROFILE),
    WLU_ADMIN("wlu-admin", Permission.CRU, RAS, STAFF_PROFILE),

    FEE_PAID_JUDGE("fee-paid-judge", Set.of(R), RAS, JUDGE_PROFILE),
    LEADERSHIP_JUDGE("leadership-judge", Set.of(R), RAS, JUDGE_PROFILE),
    CIRCUIT_JUDGE("circuit-judge", Set.of(R), RAS, JUDGE_PROFILE),
    JUDGE("judge", Set.of(R), RAS, JUDGE_PROFILE);
