    ...
    private void mapComplexClaimFields(PCSCase pcsCase, ClaimEntity claim, PcsCaseEntity pcsCaseEntity) {
        ...
        pcsCase.setRequiredDocumentsWales(
            WalesDocuments.builder()
                ...
                .noEnergyPerformanceCertificateReason(claim.getNoEnergyPerformanceCertificateReason())
                .noGasSafetyReportReason(claim.getNoGasSafetyReportReason())
                .noElectricalInstallationConditionReportReason(claim.getNoElectricalInstallationConditionReason())
