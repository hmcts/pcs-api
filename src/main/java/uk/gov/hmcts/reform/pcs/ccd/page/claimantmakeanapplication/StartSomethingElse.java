...
public class StartSomethingElse implements CcdPageConfiguration {
    ...
    private static final String INFO_MARKDOWN = """
        <p class="govuk-body">
        You can ask the court to make a decision at any point during your case.
        This is called an application.
        </p>
        <p class="govuk-body govuk-!-margin-bottom-1">For example, you can use this to:</p>

        <ul class="govuk-list govuk-list--bullet">
        <li class="govuk-!-font-size-19">add someone as an extra party to your claim</li>
        <li class="govuk-!-font-size-19">ask the court not to punish you for
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li class="govuk-!-font-size-19">what you want the court to do</li>
          <li class="govuk-!-font-size-19">why you are asking the court to do it, for example any evidence
          you have to support your application</li>
        </ul>
