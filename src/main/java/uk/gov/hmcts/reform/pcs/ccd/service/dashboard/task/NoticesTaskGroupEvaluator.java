...
@Component
public class NoticesTaskGroupEvaluator implements TaskGroupEvaluator {

    @Override
    public TaskGroupId groupId() {
        return TaskGroupId.NOTICE;
    }
    ...
    public TaskGroup evaluate(DashboardContext ctx) {
        return TaskGroup.builder()
            ...
            .tasks(ListValueUtils.wrapListItems(List.of(
                Task.builder()
                    .templateId(DashboardTaskTemplateIds.VIEW_ORDERS_AND_NOTICES)
