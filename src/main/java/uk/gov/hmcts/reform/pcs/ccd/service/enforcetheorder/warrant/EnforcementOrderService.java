...
public class EnforcementOrderService {
    ...
    private void createEnforcementOrder(long caseReference, EnforcementOrder enforcementOrder) {
        ...
        EnforcementOrderEntity orderEntity = enforcementOrderRepository.save(enforcementOrderEntity);
        ...
        if (enforcementOrder.getSelectEnforcementType() == SelectEnforcementType.WRIT
            ...
            storeEnforcementWrit(orderEntity, enforcementOrder.getWritDetails());
        }
    }
