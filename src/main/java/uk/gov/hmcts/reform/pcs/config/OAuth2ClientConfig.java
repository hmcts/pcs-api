...
public class OAuth2ClientConfig {
    ...
    public OAuth2AuthorizedClientManager authorizedClientManager(
        ...
        // Password grant credentials arrive on the OAuth2AuthorizeRequest as attributes keyed
        // by OAuth2ParameterNames; the password provider reads them from the authorization
        // context under OAuth2AuthorizationContext.*_ATTRIBUTE_NAME. Without this mapper the
        // provider sees no credentials and authorize() returns null.
