...
public class WalesCheckingNotice implements CcdPageConfiguration {
        ...
        pageBuilder
            ...
            .label("walesCheckingNotice-info",
                   ...
                   <p class="govuk-body">
                       ...
                       <li class="govuk-!-font-size-19"> the type of tenancy or license that is in place for this claim </li>
                       <li class="govuk-!-font-size-19"> how you have compiled with the applicable possession procedures </li>
                       </ul>
                   </p>
                   <p class="govuk-body">
    ...
    private AboutToStartOrSubmitResponse<PCSCase, State> midEvent(CaseDetails<PCSCase, State> details,
        ...
        if (caseData.getWalesNoticeDetails() != null && YesOrNo.NO.equals(caseData.getWalesNoticeDetails().getNoticeServed())) {
