...
public class DefenceFormPersistenceService {
    ...
    public Optional<DefenceFormRenderContext> buildContextIfNotAttached(Long defendantResponseId) {
    ...
    @Transactional
    public void attach(Long defendantResponseId, String dmStoreUrl) {
        DefendantResponseEntity response = loadResponse(defendantResponseId);
        if (response.getSubmissionDocument() != null) {
            return;
        }
    ...
    private DefendantResponseEntity loadResponse(Long defendantResponseId) {
