...
@Component
@AllArgsConstructor
public class SolicitorForDefendantAccessValidator {
    ...
    public List<PartyEntity> validateAndGetDefendants(PcsCaseEntity caseEntity, UUID authenticatedUserId) {
        ...
        return findMatchingLinkedDefendants(defendants, authenticatedUserId, caseReference);
    }
            ...
            .filter(party -> party.getClaimPartyLegalRepresentativeList()
                ...
                .anyMatch(claimPartyLegalRepresentative ->
                              claimPartyLegalRepresentative.getLegalRepresentative()
                                  .getIdamId().equals(authenticatedUserId)
