...
/**
 * Records claim-form generation outcomes in the claim_activity_log table. Failure rows carry
 * {@link GenerationDetails} in the {@code details} column; which document a success created is
 * derivable from the document table's owning pointers, not stored on the log.
 *
...
public class ClaimActivityLogService {
    ...
    public void logGenerationSuccess(long caseReference) {
        ...
        record(pcsCase, claimantParty(pcsCase), ClaimActivityStatus.SUCCESS, null);
    }
    ...
    private void record(PcsCaseEntity pcsCase, PartyEntity party,
