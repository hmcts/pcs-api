    ...
    public void addTo(PageBuilder pageBuilder) {
        pageBuilder
            ...
            .complex(PCSCase::getUnderlesseeOrMortgagee1)
                ...
                .mandatory(UnderlesseeMortgageeDetails::getPartyType)
                .mandatory(UnderlesseeMortgageeDetails::getFirstName)
                .mandatory(UnderlesseeMortgageeDetails::getLastName)
                .mandatory(UnderlesseeMortgageeDetails::getOrganisationName)
