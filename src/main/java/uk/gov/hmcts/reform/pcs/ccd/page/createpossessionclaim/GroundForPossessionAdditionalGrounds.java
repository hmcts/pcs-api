...
public class GroundForPossessionAdditionalGrounds implements CcdPageConfiguration {
    ...
    public void addTo(PageBuilder pageBuilder) {
        pageBuilder
            ...
            <p><a href='https://www.gov.uk/evicting-tenants/possession-grounds' target='_blank' 
                rel='noopener noreferrer'>More information about possession grounds (opens in new tab)</a></p>
            """)
