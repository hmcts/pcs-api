...
public class ClaimGroundService {
    ...
    private List<ClaimGroundEntity> assuredTenancyRentArrearsGroundsWithReason(PCSCase pcsCase) {
        ...
        RentArrearsGroundsForPossession groundsForPossession = pcsCase.getRentArrearsGroundsForPossession();

        Set<RentArrearsGround> rentArrearsGrounds = groundsForPossession.getRentArrearsGrounds();
        ...
        for (RentArrearsGround rentArrearsGround : rentArrearsGrounds) {
            switch (rentArrearsGround) {
                case SERIOUS_RENT_ARREARS_GROUND8:
                    ...
                    combinedMandatoryGrounds.add(AssuredMandatoryGround.SERIOUS_RENT_ARREARS_GROUND8);
                    break;
                case RENT_ARREARS_GROUND10:
                    // Ground 10 is discretionary
                    combinedDiscretionaryGrounds.add(AssuredDiscretionaryGround.RENT_ARREARS_GROUND10);
                    break;
