...
public class ReasonsNotToShare implements CcdPageConfiguration {
    ...
    private static final String INFO_MARKDOWN = """
        ...
        (the tenant, landlord, housing association or mortgage lender). This gives the other party
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li class="govuk-!-font-size-19">
            it is so urgent that there is not enough time to give notice
          </li>
          <li class="govuk-!-font-size-19">
            giving someone notice could undermine the order that you want the court to grant
          </li>
          <li class="govuk-!-font-size-19">
            you believe that you or your client are at risk from the other party
            </li>
        </ul>
        </ul>
        <div class="govuk-warning-text">
          ...
          <strong class="govuk-warning-text__text">
            ...
            We will ask you to provide the reason. The court will consider the reason, and
