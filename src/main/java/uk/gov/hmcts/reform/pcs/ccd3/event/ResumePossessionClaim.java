...
import uk.gov.hmcts.reform.pcs.ccd3.domain.ClaimantType;
...
import uk.gov.hmcts.reform.pcs.ccd3.page.builder.SavingPageBuilderFactory;
...
import uk.gov.hmcts.reform.pcs.ccd3.page.createpossessionclaim.DailyRentAmount;
...
import uk.gov.hmcts.reform.pcs.ccd3.page.createpossessionclaim.ResumeClaim;
...
import uk.gov.hmcts.reform.pcs.ccd3.page.createpossessionclaim.TenancyLicenceDetails;
...
import uk.gov.hmcts.reform.pcs.ccd3.type.DynamicStringList;
import uk.gov.hmcts.reform.pcs.ccd3.type.DynamicStringListElement;
...
import static uk.gov.hmcts.reform.pcs.ccd3.domain.State.AWAITING_FURTHER_CLAIM_DETAILS;
import static uk.gov.hmcts.reform.pcs.ccd3.domain.State.AWAITING_SUBMISSION_TO_HMCTS;
import static uk.gov.hmcts.reform.pcs.ccd3.event.EventId.resumePossessionClaim;
