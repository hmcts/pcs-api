...
public class CCDCaseRepository extends DecentralisedCaseRepository<PCSCase> {
    ...
    private PCSCase getSubmittedCase(long caseReference) {
        ...
        PCSCase pcsCase = PCSCase.builder()
            ...
            .defendant1(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "1".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant2(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "2".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant3(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "3".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant4(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "4".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant5(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "5".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant6(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "6".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant7(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "7".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant8(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "8".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant9(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "9".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant10(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "10".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant11(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "11".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant12(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "12".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant13(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "13".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant14(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "14".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant15(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "15".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant16(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "16".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant17(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "17".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant18(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "18".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant19(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "19".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant20(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "20".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant21(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "21".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant22(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "22".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant23(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "23".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant24(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "24".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .defendant25(pcsCaseService.mapToDefendantDetails(pcsCaseEntity.getDefendants()).stream()
                .filter(d -> "25".equals(d.getId()))
                .findFirst()
                .map(d -> d.getValue())
                .orElse(null))
            .build();
