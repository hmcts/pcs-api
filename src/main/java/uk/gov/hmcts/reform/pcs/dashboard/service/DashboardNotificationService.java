...
import uk.gov.hmcts.reform.pcs.dashboard.service.notifications.NotificationGenerator;
...
public class DashboardNotificationService {
    ...
    private final List<NotificationGenerator> notificationGenerators = List.of(
    ...
    public List<DashboardNotification> getNotifications(long caseReference) {
        ...
        notificationGenerators.forEach(
            generator -> notifications.addAll(generator.generateActiveNotifications(pcsCase))
        );
