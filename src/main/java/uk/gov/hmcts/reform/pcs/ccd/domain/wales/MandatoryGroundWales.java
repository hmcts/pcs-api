...
public enum MandatoryGroundWales implements HasLabel {
  ...
  LANDLORD_NOTICE_PERIODIC_S178(
      "Landlord's notice given in relation to periodic standard "
          + "contract (section 178)"),
  SERIOUS_ARREARS_PERIODIC_S181(
      "Contract-holder under a periodic standard contract "
          + "seriously in arrears with rent (section 181)"),
  LANDLORD_NOTICE_FT_END_S186(
      "Landlord's notice in connection with end of fixed term "
          + "given (section 186)"),
  SERIOUS_ARREARS_FIXED_TERM_S187(
      "Contract-holder under a fixed term standard contract "
          + "seriously in arrears with rent (section 187)"),
  ...
  CONVERTED_FIXED_TERM_SCH12_25B2(
      "Notice given in relation to end of converted fixed term "
          + "standard contract (paragraph 25B(2) of Schedule 12)");
