INSERT INTO postcode_court_mapping (postcode, epimid, legislative_country, effective_from, effective_to, audit) VALUES
    ...
    ('W95', 20262, 'England', '2025-06-01', '2035-07-31', '{"created_by": "admin", "change_reason": "initial insert"}'::jsonb),
    ('DN5 51P', 999985, 'England', '2025-06-01', '2035-11-10', '{"created_by": "admin", "change_reason": "initial insert"}'::jsonb),
    ('DN5 51P', 999984, 'England', '2025-06-01', NULL, '{"created_by": "admin", "change_reason": "initial insert"}'::jsonb),
