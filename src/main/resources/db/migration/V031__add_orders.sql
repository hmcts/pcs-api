...
CREATE INDEX orders_case_id_idam_user_id_idx ON orders(case_id, idam_user_id);
CREATE UNIQUE INDEX orders_one_draft_per_user_idx ON orders(case_id, idam_user_id) WHERE state = 'DRAFT';
