...
class CaseTypeTest {
    ...
    void shouldConfigureCaseTypeTabs() {
        ...
        final TabBuilder<PCSCase, AccessProfile> caseNotesTabBuilder = TabBuilder.builder(PCSCase.class, utils);
        ...
        final TabBuilder<PCSCase, AccessProfile> caseFlagsTabBuilder = TabBuilder.builder(PCSCase.class, utils);
