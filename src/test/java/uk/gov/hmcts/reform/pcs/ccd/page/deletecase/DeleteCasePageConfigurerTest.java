...
class DeleteCasePageConfigurerTest extends BasePageTest {

    @InjectMocks
    private DeleteCasePageConfigurer underTest;
    ...
    void shouldConfigurePagesInCorrectOrder() {
        ...
        verifyAndCount(inOrder, pageBuilder, DeleteThisCasePage.class, verificationCount);
