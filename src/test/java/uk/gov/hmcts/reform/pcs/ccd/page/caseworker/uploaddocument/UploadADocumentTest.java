package uk.gov.hmcts.reform.pcs.ccd.page.caseworker.uploaddocument;
...
class UploadADocumentTest extends BasePageTest {
    ...
    @BeforeEach
    void setUp() {
        setPageUnderTest(new UploadADocument(UK_CLOCK));
    }

    @Test
    void shouldReturnErrorWhenIssueDateIsInFuture() {
        PCSCase caseData = PCSCase.builder()
            .caseworkerDocument(CaseworkerDocument.builder()
