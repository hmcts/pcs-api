...
class DeleteDraftClaimConfigurerTest extends BasePageTest {

    @InjectMocks
    private DeleteDraftClaimConfigurer underTest;
    ...
    void shouldConfigurePagesInCorrectOrder() {
        ...
        verifyAndCount(inOrder, pageBuilder, DeleteDraftClaimPage.class, verificationCount);
