...
class GenAppsViewTest {
    ...
    @BeforeEach
    void setUp() {
        lenient().when(organisationService.getOrganisationIdForCurrentUser()).thenReturn(ORG_ID);
        ...
        underTest = new GenAppsView(organisationService, genAppVisibilityService);
    }
