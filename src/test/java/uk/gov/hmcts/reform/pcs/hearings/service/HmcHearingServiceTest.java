...
class HmcHearingServiceTest {
    ...
    void setUp() {
        ...
        when(systemUpdateUserTokenProvider.getAuthToken()).thenReturn(AUTH_HEADER);
        hmcHearingService = new HmcHearingService(hmcHearingApi, authTokenGenerator, systemUpdateUserTokenProvider);
    }
