...
public class AddCaseNotePageTest extends BasePageTest {
    ...
    void setUp() {
        ...
        setPageUnderTest(new AddCaseNotePage(textAreaValidationService));
    }

    @Test
    void shouldValidateCaseNote() {
        // Given
        String note = "Case Note";
        String label = "Note";
        Integer characterLimit = 500;
        PCSCase caseData = PCSCase.builder().note(note).build();
