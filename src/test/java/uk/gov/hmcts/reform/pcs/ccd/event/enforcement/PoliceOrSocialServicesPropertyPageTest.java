...
class PoliceOrSocialServicesPropertyPageTest extends BasePageTest {

    @BeforeEach
    void setUp() {
        setPageUnderTest(new PoliceOrSocialServicesPropertyPage());
    }
    ...
    void shouldRequireTextWhenInvalid(String invalidText) {
        ...
        PCSCase caseData = PCSCase.builder()
            .enforcementPoliceOrSocialServicesDetails(invalidText).build();
    ...
    void shouldAcceptValidText(String text) {
        // Given
        PCSCase caseData = PCSCase.builder()
            .enforcementPoliceOrSocialServicesDetails(text).build();
        ...
        assertThat(response.getData().getEnforcementPoliceOrSocialServicesDetails()).isEqualTo(text);
    }
    ...
    void shouldRejectTextOver6800Characters() {
        ...
        PCSCase caseData = PCSCase.builder()
            .enforcementPoliceOrSocialServicesDetails(longText).build();

        // When
        AboutToStartOrSubmitResponse<PCSCase, State> response = callMidEventHandler(caseData);

        // Then
        assertThat(response.getErrors()).containsExactly("In 'Why did the police or social services " +
                                                             "visit the property?' " +
    ...
    void shouldPreserveDataWhenValid() {
        ...
        PCSCase caseData = PCSCase.builder()
            ...
            .enforcementPoliceOrSocialServicesDetails("Criminal record")
            .build();
        ...
        assertThat(response.getData().getEnforcementPoliceOrSocialServicesDetails())
            .isEqualTo("Criminal record");
    }
