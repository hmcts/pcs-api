...
| selectMandatoryAndDiscretionaryGrounds | `performAction('selectMandatoryAndDiscretionaryGrounds', {mandatory : [whatAreYourGrounds.mandatory.holidayLet],discretionary :[whatAreYourGrounds.discretionary.domesticViolence]})`                      |
| enterReasonForPossession               | `performAction('enterReasonForPossession', [whatAreYourGrounds.mandatory.holidayLet,whatAreYourGrounds.mandatory.ownerOccupier,whatAreYourGrounds.discretionary.rentArrears])`                             |
