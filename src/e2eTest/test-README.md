...
| selectMandatoryAndDiscretionaryGrounds | `performAction('selectMandatoryAndDiscretionaryGrounds', {mandatory : [whatAreYourGrounds.mandatory.holidayLet]});`                                                                                        |
| enterReasonForPossession               | `performAction('enterReasonForPossession', [whatAreYourGrounds.mandatory.holidayLet]);`                                                                                                                    |
### Validations
