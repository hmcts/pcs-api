...
| selectHousingAct                         | `performAction('selectHousingAct', housingAct.section6AHousingAct1988)`                                                                                                                                    |
| enterReasonForRequestingASuspensionOrder | `performAction('enterReasonForRequestingASuspensionOrder', reasonsForRequestingASuspensionOrder.reason)`                                                                                                   |
### Validations
