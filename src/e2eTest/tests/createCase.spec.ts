...
test.describe('[Create Case - England] @PR', async () => {
  test('England - Assured tenancy with Rent arrears and other possession grounds @regression', async () => {
  ...
  test('England - Assured tenancy with No Rent arrears', async () => {
    ...
    await performValidation('mainHeader', whatAreYourGroundsForPossession.gfpMainHeader);
    await performAction('selectYourPossessionGrounds', {
      mandatory : [whatAreYourGroundsForPossession.mandatory.holidayLet, whatAreYourGroundsForPossession.mandatory.ownerOccupier],
