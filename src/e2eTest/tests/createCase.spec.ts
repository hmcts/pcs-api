...
test.describe("[Create Case Flow]  @Master @nightly", async () => {
  test("England - Successful case creation with Assured tenancy", async () => {
    ...
    await performAction("selectRentArrearsPossessionGround", {
      rentArrears: [
        rentArrearsPossessionGrounds.rentArrears,
        rentArrearsPossessionGrounds.seriousRentArrears,
        rentArrearsPossessionGrounds.persistentDelayInPayingRent,
      ],
    ...
    await performAction("selectOtherGrounds", {
      mandatory: [
        ...
        whatAreYourGroundsForPossession.mandatory.ownerOccupier,
      ],
      discretionary: [
        whatAreYourGroundsForPossession.discretionary.domesticViolence14A,
        whatAreYourGroundsForPossession.discretionary.rentArrears,
      ],
    });
  ...
  test("Wales - Successful case creation with Saved options for secure tenancy type with rent and other grounds", async () => {
    ...
    await performAction("selectYourPossessionGrounds", {
      discretionary: [
        whatAreYourGroundsForPossession.discretionary.rentArrearsOrBreachOfTenancy,
        whatAreYourGroundsForPossession.discretionary.deteriorationOfFurniture,
      ],
      mandatory: [whatAreYourGroundsForPossession.mandatory.antiSocialBehaviour],
      mandatoryAccommodation: [
        whatAreYourGroundsForPossession.mandatoryWithAccommodation.charitableLandlords,
        whatAreYourGroundsForPossession.mandatoryWithAccommodation.landlordsWorks,
      ],
      discretionaryAccommodation: [
        whatAreYourGroundsForPossession.discretionaryWithAccommodation.adapted,
        whatAreYourGroundsForPossession.discretionaryWithAccommodation.tied,
      ],
    });
    await performValidation("mainHeader", rentArrearsOrBreachOfTenancy.mainHeader);
    await performAction("selectRentArrearsOrBreachOfTenancy", {
    ...
    await performAction("enterReasonForPossession", [
      whatAreYourGroundsForPossession.discretionary.deteriorationOfFurniture,
      whatAreYourGroundsForPossession.mandatory.antiSocialBehaviour,
      whatAreYourGroundsForPossession.mandatoryWithAccommodation.charitableLandlords,
      whatAreYourGroundsForPossession.mandatoryWithAccommodation.landlordsWorks,
      whatAreYourGroundsForPossession.discretionaryWithAccommodation.adapted,
      whatAreYourGroundsForPossession.discretionaryWithAccommodation.tied,
