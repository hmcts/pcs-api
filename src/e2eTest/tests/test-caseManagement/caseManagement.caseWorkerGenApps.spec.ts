...
import { enterGenappApplication, enterGenAppapplicationFee, enterGenAppConsentAndNotice, enterGenAppHearingDate, enterGenAppPreferApplicationToJudge, enterGenAppUploadGeneralApplication, enterGenAppuploadRelatedEvidence, genAppsCheckYouAnswers } from '@data/page-data-figma/page-data-caseManagement-figma';
...
test.describe('Case management - Case Worker Enter a General application @nightly', async () => {
  test('Case management - Case Worker Enter a General application ADJOURN Journey @CM @regression', async () => {
    ...
    await performAction('uploadADocument', { label: enterGenAppUploadGeneralApplication.uploadADocumentParagraph, file: fileName });    
