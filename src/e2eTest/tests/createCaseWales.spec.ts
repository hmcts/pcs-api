...
>>>>>>> origin/master
  ...
  test('Wales - Secure contract - Rent arrears + ASB + other options @MAC', async () => {
    ...
    await performAction('selectNoticeOfYourIntention', {
      question: checkingNotice.haveYouServedNoticeToQuestion,
      option: checkingNotice.noRadioOption,
      guidanceParagraph: checkingNotice.noServedNoticeStatementParagraph,
      bullet1: checkingNotice.noServedNoticeStatementBulletinListItem1,
      bullet2: checkingNotice.noServedNoticeStatementBulletinListItem2,
      endStatementInstruction: checkingNotice.noServedNoticeStratStatementParagraph,
      statementLabel: checkingNotice.noServedNoticeEnterStatementTextLabel,
      characterHint: checkingNotice.noServedNoticeEnterStatementHintText,
      statementInput: checkingNotice.noServedNoticeEnterStatementTextInput,
    });
    await performValidation('mainHeader', rentDetails.mainHeader);
    await performAction('provideRentDetails', { rentFrequencyOption: 'Monthly', rentAmount: '1000' });
    await performValidation('mainHeader', rentArrears.mainHeader);
