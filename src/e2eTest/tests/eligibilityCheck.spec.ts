...
test.describe('[Eligibility Check - Create Case] @nightly', async () => {
  test('Cross border - Verify postcode eligibility check redirection and content for England and Wales @smoke', async () => {
