...
import {borderPostcode, addressDetails, canNotUseOnlineService, propertyIneligible, userIneligible,
  claimantType, claimType, addressCheckYourAnswers} from '@data/page-data';
