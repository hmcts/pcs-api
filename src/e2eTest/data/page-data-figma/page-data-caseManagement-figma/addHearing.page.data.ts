export const addHearing = {
  ...
  errorValidationField: {
    ...
    errorMoneyField: [
      { type: `negative`, input: `-5`, input1: `10`, index: 1,errMessage: `Should be more than or equal to 0`},
      { type: `negative`, input: `5`, input1: `-5`, index: 1,errMessage1: `Should be more than or equal to 0`},
      ...
      { type: `alpha`, input: `test`, input1: `10`, index: 1, errMessage: `The data entered is not valid for Hours` },
      { type: `alpha`, input: `10`, input1: `test`, index: 1, errMessage1: `The data entered is not valid for Minutes` },
      { type: `empty`, input: ``, input1: `10`, index: 1, errMessage: `Hours is required` },
      { type: `empty`, input: `10`, input1: ``, index: 1, errMessage1: `Minutes is required` },
    ],
  },
}