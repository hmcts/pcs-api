export const addHearing = {
  ...
  errorValidationField: {
    ...
    errorMoneyField: [
      { type: `negative`, input: `-5`, input1: `10`, input2: `5`,index: 0,errMessage: `Should be more than or equal to 0`},
      { type: `negative`, input: `5`, input1: `-5`, input2: `5`,index: 0,errMessage1: `Should be more than or equal to 0`},
      { type: `negative`, input: `5`, input1: `5`, input2: `-5`, index: 0,errMessage2: `Should be more than or equal to 0`},
      { type: `max`, input: `60`, input1: `10`, input2: `10`,index: 0, errMessage: `Should be less than or equal to 23`, errMessage1: ``, errMessage2: `` },
      { type: `max`, input: `23`, input1: `100`, input2: `10`,index: 0, errMessage1: `Should be less than or equal to 59` },
      { type: `max`, input: `23`, input1: `10`, input2: `101`,index: 0, errMessage2: `Should be less than or equal to 100` },
      { type: `alpha`, input: `test`, input1: `10`, input2: `10`,index: 0, errMessage: `The data entered is not valid for Hours` },
      { type: `alpha`, input: `10`, input1: `test`,input2: `10`, index: 0, errMessage1: `The data entered is not valid for Minutes` },
      { type: `alpha`, input: `10`, input1: `10`, input2: `test`,index: 0, errMessage2: `The data entered is not valid for Days` },
      { type: `empty`, input: ``, input1: `10`,input2: `10`, index: 0, errMessage: `Hours is required` },
      { type: `empty`, input: `10`, input1: ``, input2: `10`,index: 0, errMessage1: `Minutes is required` },
      { type: `empty`, input: `10`, input1: `10`, input2: ``,index: 0, errMessage2: `Days is required` },
    ],
  },
}