export const users = [{
  user: 'Creator',
  email: 'pcs.solicitor.orguser3@hmcts.net', //pcs-solicitor2@test.com',
...
},
{
  ...
  email: 'pcs.solicitor.orguser4@hmcts.net', //pcs-solicitor-user01@test.com',
  password: process.env.IDAM_PCS_USER_PASSWORD,
  tabAccess: ['Case Parties', 'Case Details', 'Case File View', 'Summary', 'Service Request']
},
{
  user: 'Defendant Solicitor',
  email: 'pcs.solicitor.org2user3@hmcts.net', // 'pcs-org1-solicitor2@test.com',
  password: process.env.IDAM_PCS_USER_PASSWORD,
  tabAccess: ['Case Parties', 'Case Details', 'Case File View', 'Summary', 'Service Request']
},
{
