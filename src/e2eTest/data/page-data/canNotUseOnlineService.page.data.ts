export const canNotUseOnlineService = {
    ...
    basedOnPostcodeContent: 'Based on the postcode you provided, we cannot determine which court your claim should be ' 
        + 'assigned to, so you cannot use this online service.',
    claimsInEnglandContent: 'For other types of claims in England – fill in form N5 and the correct particulars of ' 
        + 'claim form.',
