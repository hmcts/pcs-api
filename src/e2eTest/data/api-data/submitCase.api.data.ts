export const submitCaseApiData = {
  ...
  submitCasePayloadCaseSummary: {
    ...
    notice_NoticeEmailAddress: 'test@gmail.com',
    notice_NoticeEmailSentDateTime: '2025-12-11T14:22:59',
  ...
  submitCasePayloadCaseDetails: {
    ...
    showIntroductoryDemotedOtherGroundReasonPage: 'Yes',
    introGrounds_HasIntroductoryDemotedOtherGroundsForPossession: 'YES',
    introGrounds_IntroductoryDemotedOrOtherGrounds: ['RENT_ARREARS', 'ANTI_SOCIAL'],
    ...
    defendantCircumstancesInfo: 'Defendants circumstances',
    suspensionOfRTB_ShowHousingActsPage: 'No',
    demotionOfTenancy_ShowHousingActsPage: 'Yes',
    suspensionToBuyDemotionOfTenancyPages: 'No',
    alternativesToPossession: ['DEMOTION_OF_TENANCY'],
    demotionOfTenancy_HousingAct: 'SECTION_82A_2',
    demotionOfTenancy_StatementOfExpressTermsServed: 'YES',
    demotionOfTenancy_StatementOfExpressTermsDetails: 'SOT',
    demotionOfTenancy_Reason: 'demotion test data',
    additionalReasonsForPossession: {
      hasReasons: 'NO',
      reasons: null
    },
