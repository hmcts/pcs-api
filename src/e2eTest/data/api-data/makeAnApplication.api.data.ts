export const makeAnApplicationApiData = {
  ...
  makeAnApplicationAdjournWalesPayload: (defendantId: string, defendantName: string) => (
    ...
    makeAnApplicationAdjournWalesWithOutNoticePayload: (defendantId: string, defendantName: string) => (
    {
      currentRepresentedPartyId: defendantId,
      currentRepresentedPartyName: defendantName,
      xui_genapp_StandardFee: '£123',
      ...
      xui_genapp_WithoutNoticeReason: 'testing payload123',
      xui_genapp_WhatOrderWanted: 'test user input',
      xui_genapp_HasSupportingDocuments: 'YES',
      xui_genapp_UploadedDocuments: [
        {
  ...
  makeAnApplicationstartSetAsidePayload: (defendantId: string, defendantName: string) => (
    {
      currentRepresentedPartyId: defendantId,
      currentRepresentedPartyName: defendantName,
      xui_genapp_StandardFee: '£123',
  ...
  makeAnApplicationSomethingElseWithNoticePayload: (defendantId: string, defendantName: string) => (
    {
      currentRepresentedPartyId: defendantId,
      currentRepresentedPartyName: defendantName,
      xui_genapp_StandardFee: '£123',
  ...
  makeAnApplicationAdjournWithOutNoticePayload: (defendantId: string, defendantName: string) => (
    {
      currentRepresentedPartyId: defendantId,
      currentRepresentedPartyName: defendantName,
      xui_genapp_StandardFee: '£123',
