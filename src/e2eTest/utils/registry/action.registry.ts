...
export class ActionRegistry {
  private static actions: Map<string, IAction> = new Map<string, IAction>([
    ...
    ['clickCaseNumberLink', new GlobalSearchCaseAction()],
    ['searchByNameAndPostcode', new GlobalSearchCaseAction()],
    ['searchByAddressAndPostcode', new GlobalSearchCaseAction()],
    ['searchByNameAndService', new GlobalSearchCaseAction()],
    ['searchByInvalidCombination', new GlobalSearchCaseAction()],
    ['selectClaimingCosts', new CreateCaseAction()],
