...
export class EnforcementAction implements IAction {
  async execute(page: Page, action: string, fieldName: string | actionRecord, data?: actionData): Promise<void> {
    const actionsMap = new Map<string, () => Promise<void>>([
      ...
      [
        "selectRiskPosedByEveryoneAtProperty",
        () => this.selectRiskPosedByEveryoneAtProperty(fieldName as actionRecord),
      ],
      [
        "provideDetailsViolentOrAggressiveBehaviour",
        () => this.provideDetailsViolentOrAggressiveBehaviour(fieldName as actionRecord),
      ],
      ["provideDetailsFireArmPossession", () => this.provideDetailsFireArmPossession(fieldName as actionRecord)],
      [
        "provideDetailsCriminalOrAntisocialBehavior",
        () => this.provideDetailsCriminalOrAntisocialBehavior(fieldName as actionRecord),
      ],
      [
        "provideDetailsVerbalOrWrittenThreats",
        () => this.provideDetailsVerbalOrWrittenThreats(fieldName as actionRecord),
      ],
      [
        "provideDetailsGroupProtestsEviction",
        () => this.provideDetailsGroupProtestsEviction(fieldName as actionRecord),
      ],
      [
        "provideDetailsPoliceOrSocialServiceVisits",
