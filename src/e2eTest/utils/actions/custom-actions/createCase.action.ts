...
export class CreateCaseAction implements IAction {
  ...
  public async validateCaseFileViewFolders(page: Page, caseFileView: actionData){
    ...
    // report folders as missing while they were still on their way. That is the same
    // non-polling-probe shape as the other fixes here, and the sibling validator below already
