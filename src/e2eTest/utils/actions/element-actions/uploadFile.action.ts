  ...
  // Sleep only the part of the gap not already elapsed. Logs what it skipped so the saving is
  // measurable from the console rather than inferred from the suite total.
