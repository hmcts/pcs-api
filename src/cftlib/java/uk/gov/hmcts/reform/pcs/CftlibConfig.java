...
public class CftlibConfig implements CFTLibConfigurer {
    ...
    public void configure(CFTLib lib) throws Exception {
        ...
        var users = Map.of(
            ...
            "pcs-defendant-solicitor@test.com", List.of("pui-case-manager", "caseworker", "caseworker-pcs-solicitor","caseworker-divorce-solicitor"),
    ...
    private void createAccessProfiles(CFTLib lib) {
        ...
        roleNames.add("caseworker-approver");
